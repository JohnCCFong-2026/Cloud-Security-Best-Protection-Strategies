...
##### 🛡️ Azure Information Protection (AIP)
- **Data Classification & Labeling**  
  Classify and label sensitive data for compliance.
- **Persistent Protection**  
  Encryption and rights management travel with the data.
- **Example**: A law firm labels confidential documents as “Restricted.” Even if emailed externally, access is blocked without proper rights.
